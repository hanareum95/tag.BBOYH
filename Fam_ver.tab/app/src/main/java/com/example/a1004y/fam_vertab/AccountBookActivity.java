...
public class AccountBookActivity extends AppCompatActivity {
    ...
    PreferenceClass pref = new PreferenceClass(AccountBookActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AccountBookActivity.this, HomeActivity.class));
            }
        });
        ...
        btn_setting = (Button)findViewById(R.id.button_account_setting);
        btn_setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //startActivity(new Intent(AccountBookActivity.this, SettingsActivity.class));
            }
        });*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent = new Intent(AccountBookActivity.this, GroupListActivity.class);
